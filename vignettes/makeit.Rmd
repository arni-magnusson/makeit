...
We start by copying the examples to the current directory:
...
Before the workflow is run, we have two files:

```{r, echo=FALSE, comment=""}
cat(dir("examples/analysis"), sep="\n")
```

Run example:

```{r}
setwd("examples/analysis")
dir()
