...
(found at the beginning and end of the script) is usually a better workflow
design than managing a large monolithic script where the user navigates between
sections to run selected blocks of code.
...
Reproducible Research. https://cran.r-project.org/package=TAF.
...
Open Source Software, 6(57), 2959. https://doi.org/10.21105/joss.02959.
