...
The general idea is to run a workflow without repeating tasks that were already
completed. The workflow consists of one or more scripts, where each script
generates file.

This tutorial consists of five annotated examples, demonstrating how the make()
function is used to run an R script if underlying files have changed, otherwise
do nothing.



A typical application
For example, updating tables and plots without rerunning
...
<img src="https://raw.githubusercontent.com/arni-magnusson/makeit/main/inst/examples/dag_wikipedia.png" alt="diagram" width="120">
...
<img src="https://raw.githubusercontent.com/arni-magnusson/makeit/main/inst/examples/dag_targets.png" alt="diagram" width="400">
